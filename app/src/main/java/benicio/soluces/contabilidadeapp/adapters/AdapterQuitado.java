...
public class AdapterQuitado extends RecyclerView.Adapter<AdapterQuitado.MyViewHolder>{

    AdapterPagamento adapter;
    List<ClienteModel> lista;
    Context context;

    public AdapterQuitado(List<ClienteModel> lista, Context context) {
        this.lista = lista;
    ...
    @NonNull
    @Override
    public AdapterQuitado.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.cliente_layout, parent, false);
        return new AdapterQuitado.MyViewHolder(v);
    }

    @SuppressLint("DefaultLocale")
    @Override
    public void onBindViewHolder(@NonNull AdapterQuitado.MyViewHolder holder, int position) {
        ...
        if ( clienteModel.getListaPagamentos() != null){
            ...
            if ( clienteModel.getListaPagamentos() != null){
                ...
                ClienteStorageUtil.saveClientesQuitado(context, lista);
